...
/** @def CPPCSP_CONTEXT
*
*	This symbol is defined when C++CSP2 is using setcontext/getcontext as its implementation mechanism for sub-threads.
*
*	It is based on CPPCSP_POSIX, as it is the only sub-thread implementation on POSIX.  If CPPCSP_POSIX is defined,
*	CPPCSP_CONTEXT will be defined.
*/	
